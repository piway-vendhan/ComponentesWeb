  ...
  a.fn.extend({
     slidorion:function(b){ 
		 ...
		 return this.each(function(){
		            function B(b){
					     var c=a("#slider",s).outerHeight();
						 var d=a("#slider",s).outerWidth();
						 var e,f,g,h=0;
						 var i=s.css("backgroundColor");
						 a(".slider-image img",s).each(function(){
							 ...
							 a(this).css({"z-index":l});l++});
							 a('.slider-image[rel="'+b+'"] img',s).css({"z-index":l});l++
				    }
					function A(){
