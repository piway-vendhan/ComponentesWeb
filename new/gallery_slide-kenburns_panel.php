...
<head>
	<meta charset="utf-8">
	<title>Kenburns Panel: Gallery Slide - Componentes Web - Asisco</title>
...
<body data-spy="scroll" data-target=".bs-docs-sidebar"> 
	...
	<div class="container">
	    <h2 class="page-header">Kenburns Panel</h2>
		<!-- kenburn Panel -->	
			<script src="gallery/slide/asisco/meedel/jquery-1.7.2.min.js"></script>
		
			<link rel="stylesheet" type="text/css" href="gallery/slide/asisco/meedel/kenburns_panel_7/css/kenburns-panel-settings.css" media="screen" />
			<!-- DC Ken Burns Panel Slider JS -->
			<script type="text/javascript" src="gallery/slide/asisco/meedel/kenburns_panel_7/js/jquery.waitforimages.js"></script>
			<script type="text/javascript" src="gallery/slide/asisco/meedel/kenburns_panel_7/js/jquery.cssAnimate.mini.js"></script>
			<script type="text/javascript" src="gallery/slide/asisco/meedel/kenburns_panel_7/js/jquery.touchwipe.min.js"></script>
			<script type="text/javascript" src="gallery/slide/asisco/meedel/kenburns_panel_7/js/jquery.templateaccess.kenburns-panel.min.js"></script>
			...
			$(function() {   
				$('.kbpanel-bannercontainer').kenburn({
					...
					/////////////////////////////////////////////////////////////////////////////////////////////////////////////
					googleFonts:'Oswald',
					googleFontJS:'gallery/slide/asisco/meedel/kenburns_panel_7/js/jquery.googlefonts.js'
				});
				...
				<div class="slider_box">
					...
					<div style=" margin:0 auto; position:relative;overflow:hidden;"> <!-- define slider container width (by strict force) -->
						<div class="demoholder">
							...
							<!-- <di class="kbpanel-bannercontainer centerme light"> light theme -->
							<div class="kbpanel-bannercontainer centerme dark">
								<ul>
									  <!-- Slide 1 -->
									  <li data-transition="fade" data-startalign="right,bottom" data-zoom="in" data-zoomfact="3" data-endAlign="center,top" data-panduration="12" data-colortransition="4"><img alt="" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/image1.jpg" data-bw="gallery/slide/asisco/meedel/kenburns_panel_7/images/image1.jpg" data-thumb="gallery/slide/asisco/meedel/kenburns_panel_7/images/image1.jpg">
									  ...
									  <!-- Slide 2 -->
									  <li data-transition="slide" data-startalign="right,top" data-zoom="out" data-zoomfact="1.5" data-endAlign="left,bottom" data-panduration="8" data-colortransition="4"><img alt="" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/image2.jpg" data-bw="gallery/slide/asisco/meedel/kenburns_panel_7/images/image2.jpg" data-thumb="gallery/slide/asisco/meedel/kenburns_panel_7/images/image2.jpg">
									  ...
									  <!-- Slide 3 -->
									  <li data-transition="slide" data-startalign="left,bottom" data-zoom="in" data-zoomfact="3" data-endAlign="center,center" data-panduration="8" data-colortransition="4"><img alt="" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/image3.jpg" data-bw="gallery/slide/asisco/meedel/kenburns_panel_7/images/image3.jpg" data-thumb="gallery/slide/asisco/meedel/kenburns_panel_7/images/image3.jpg">
										<div class="creative_layer ">
									  ...
									  <!-- Slide 4 -->
									  <li data-transition="fade" data-startalign="right,top" data-zoom="out" data-zoomfact="1.2" data-endAlign="left,bottom" data-panduration="11" data-colortransition="4"><img alt="" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/image4.jpg" data-bw="gallery/slide/asisco/meedel/kenburns_panel_7/images/image4.jpg" data-thumb="gallery/slide/asisco/meedel/kenburns_panel_7/images/image4.jpg">
										<div class="creative_layer ">
									  ...
									  <!-- Slide 5 -->
									  <li data-transition="fade" data-startalign="center,top" data-zoom="in" data-zoomfact="1.6" data-endAlign="center,bottom" data-panduration="12" data-colortransition="4"><img alt="" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/image5.jpg" data-bw="gallery/slide/asisco/meedel/kenburns_panel_7/images/image5.jpg" data-thumb="gallery/slide/asisco/meedel/kenburns_panel_7/images/image5.jpg">
										<div class="video_kenburner">
										  <div class="video_kenburn_wrap">
											<div class="video_video">
							...
							<div class="bannershadow centerme"><img width="100%" height="40px" src="gallery/slide/asisco/meedel/kenburns_panel_7/images/bannershadow.png"></div>
						</div>
						<!-- /demoholder --> 
	   ...
	   <!-- Fim kenburn Panel --> 				
		...
		<br/>
		<p>
		   <a href="gallery_slide-kenburns_panel-only.html" target="_blank" class="btn btn-primary">Only</a>
