...
<body data-spy="scroll" data-target=".bs-docs-sidebar"> 
	...
	<div class="container">
	    <h2 class="page-header">Fancy Box</h2>
		<!-- Componentes -->
				Aki Seu Componentes Web...
		<!-- fim Componentes -->
		
		<p>
		   <a href="#" target="_blank" class="btn btn-primary">Only</a>
		   <a href="https://github.com/componentesweb/fancyBox.git" class="btn" target="_blank">Download (Git)</a> 
		</p>			
